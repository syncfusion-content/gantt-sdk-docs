var GanttData = [
  ...
  { TaskID: 5,  TaskName: 'Concept Approval', StartDate: new Date('04/02/2019'), Duration: 0, Predecessor: '3,4', ParentID: 1,
    Indicators: [{ date: new Date('04/10/2019'), name: '#briefing', title: 'Product concept breifing' }] },
  ...
  { TaskID: 12, TaskName: 'Research complete', StartDate: new Date('04/04/2019'), Duration: 0, Predecessor: '10', ParentID: 6,
    Indicators: [{ date: new Date('04/20/2019'), name: '#meeting', title: '1st board of directors meeting' }] },
  ...
  { TaskID: 27, TaskName: 'Design complete', StartDate: new Date('04/04/2019'), Duration: 0, Predecessor: '26', ParentID: 13,
    Indicators: [{ date: new Date('05/18/2019'), name: '#meeting', title: '2nd board of directors meeting' }] },

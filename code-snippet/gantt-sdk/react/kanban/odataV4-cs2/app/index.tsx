...
function App(){
   let data = new DataManager({
    ...
    return(
      <KanbanComponent id="kanban" keyField="ContactTitle" dataSource={data} cardSettings={{ contentField: "ContactName", headerField: "SupplierID" }} allowDragAndDrop={false} dialogOpen={DialogOpen.bind(this)}>
          <ColumnsDirective>

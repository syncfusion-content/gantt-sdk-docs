export const data = [
    { TaskID: 1, TaskName: 'Project initiation', StartDate: new Date('03/29/2019'), EndDate: new Date('04/21/2019'), taskType: 'FixedUnit', ParentID: null },
    ...
    { TaskID: 5, TaskName: 'Project estimation', StartDate: new Date('03/29/2019'), EndDate: new Date('04/21/2019'), taskType: 'FixedUnit', ParentID: null },
    ...
    { TaskID: 9, TaskName: 'Sign contract', StartDate: new Date('04/01/2019'), Duration: 1, Progress: 30, resources: [12], Work: 24, taskType: 'FixedDuration', ParentID: null }
];

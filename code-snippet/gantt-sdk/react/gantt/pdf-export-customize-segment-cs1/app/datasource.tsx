export const GanttData: object[] = [
    ...
    { TaskID: 2, TaskName: 'Identify Site location', StartDate: new Date('04/02/2019'), Duration: 4, Progress: 50, ParentID: 1, Segments: [{ StartDate: new Date('04/02/2019'), Duration: 2 }, { StartDate: new Date('04/04/2019'), Duration: 2 }] },
    { TaskID: 3, TaskName: 'Perform Soil test', StartDate: new Date('04/02/2019'), Duration: 4, Progress: 50, ParentID: 1 },
    { TaskID: 4, TaskName: 'Soil test approval', StartDate: new Date('04/02/2019'), Duration: 4, Progress: 50, ParentID: 1, Segments: [{ StartDate: new Date('04/02/2019'), Duration: 2 }, { StartDate: new Date('04/04/2019'), Duration: 2 }] },

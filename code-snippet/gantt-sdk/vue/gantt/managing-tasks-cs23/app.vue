  ...
  data: function() {
      return{
            ...
            columns: [
                ...
                { field: 'TaskName', headerText: 'Task Name', width: '250', validationRules: { required: true, minLength: [(args) => {return args['value'].length <= 8;}, 'Value should be within 8 letters'] } },

...
const autoUpdatePredecessorOffset = ref(true);
...
function onToggleChange(args) {
    autoUpdatePredecessorOffset.value = args.checked;

    if (ganttRef.value) {
        ganttRef.value.ej2Instances.autoUpdatePredecessorOffset = args.checked;
    }
}
</script>

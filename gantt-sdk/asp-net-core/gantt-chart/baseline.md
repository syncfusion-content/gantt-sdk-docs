---
layout: post
title: Baseline in ASP.NET Core Gantt Chart | Syncfusion
description: Learn how to use the Baseline feature in Syncfusion ASP.NET Core Gantt Chart to compare planned schedules with actual task execution timelines.
...
canonical: https://help.syncfusion.com/gantt-sdk/asp-net-core/gantt-chart/baseline
platform: gantt-sdk
...
# Baseline for Schedule Comparison in ASP.NET Core Gantt Chart

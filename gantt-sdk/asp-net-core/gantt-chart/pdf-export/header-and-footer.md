...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/pdf-customization/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="PDF-customization.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/pdf-customization/pdf-customization.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/pdf-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="PDF-customization.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/pdf-customization/pdf-customization.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/footer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Footer.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/footer/footer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/footer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Footer.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/pdf-export/footer/footer.cs %}
{% endhighlight %}

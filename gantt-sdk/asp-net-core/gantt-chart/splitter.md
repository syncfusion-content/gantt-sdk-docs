...
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/how-to/changeSplitter/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/how-to/setSplitterPosition/tagHelper %}
{% endhighlight %}

...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/defaultdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Defaultdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/defaultdrag/defaultdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/defaultdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Defaultdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/defaultdrag/defaultdrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/multidrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Multidrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/multidrag/multidrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/multidrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multidrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/multidrag/multidrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/taskbardragdrop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="TaskbarDragDrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/taskbardragdrop/taskbardragdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/taskbardragdrop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="TaskbarDragDrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/taskbardragdrop/taskbardragdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrag/preventdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrag/preventdrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrop/preventdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventdrop/preventdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventReorder/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="PreventReorder.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventReorder/preventReorder.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventReorder/razor %}
{% endhighlight %}
{% highlight c# tabtitle="PreventReorder.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/preventReorder/preventReorder.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/dynamicdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamicdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/dynamicdrag/dynamicdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/dynamicdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamicdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/rows/dynamicdrag/dynamicdrag.cs %}
{% endhighlight %}

---
layout: post
title: Column Resizing in ASP.NET Core Gantt Chart | Syncfusion
description: Learn how to enable column resizing in Syncfusion ASP.NET Core Gantt Chart allowing users to adjust column widths interactively.
...
canonical: https://help.syncfusion.com/gantt-sdk/asp-net-core/gantt-chart/columns/column-resizing
platform: gantt-sdk
...
# Column Resizing in ASP.NET Core Gantt Chart
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/columns/resizeColumns/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ResizeColumns.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/columns/resizeColumns/resizeColumns.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/columns/minMaxWidth/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="MinMaxWidth.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/columns/minMaxWidth/minMaxWidth.cs %}
{% endhighlight %}
{% endtabs %}

## Touch interaction

When the right edge of the column header cell is `tapped`, a floating handler will be visible over the right border of the column. To [`resize`](https://help.syncfusion.com/gantt-sdk/asp-net-core/gantt-chart/columns/#column-resizing) the column, drag the floating handler as needed.

The following screenshot represents the Gantt column resizing in touch device.

![Column resize](https://help.syncfusion.com/gantt-sdk/images/column-resize.png)

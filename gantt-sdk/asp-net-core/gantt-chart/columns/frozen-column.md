...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenColumn/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="frozenColumn.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenColumn/frozenColumn.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenColumn/razor %}
{% endhighlight %}
{% highlight c# tabtitle="frozenColumn.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenColumn/frozenColumn.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeColumn/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="freezeColumn.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeColumn/freezeColumn.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeColumn/razor %}
{% endhighlight %}
{% highlight c# tabtitle="freezeColumn.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeColumn/freezeColumn.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeDirection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="freezeDirection.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeDirection/freezeDirection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeDirection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="freezeDirection.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/freezeDirection/freezeDirection.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenLineColor/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="frozenLineColor.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenLineColor/frozenLineColor.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenLineColor/razor %}
{% endhighlight %}
{% highlight c# tabtitle="frozenLineColor.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/columns/frozenLineColor/frozenLineColor.cs %}
{% endhighlight %}

...
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/predecessor/allowedDependencyTypes/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="allowedDependencyTypes.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/predecessor/allowedDependencyTypes/allowedDependencyTypes.cs %}
{% endhighlight %}
{% endtabs %}

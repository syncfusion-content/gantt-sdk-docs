...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/custom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Column-prevent.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/custom/column-prevent.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/custom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Column-prevent.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/custom/column-prevent.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/default/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Column-persist.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/default/column-persist.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/default/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Column-persist.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/state-persist/default/column-persist.cs %}
{% endhighlight %}

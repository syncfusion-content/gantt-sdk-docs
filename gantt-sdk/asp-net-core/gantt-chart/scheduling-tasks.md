...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/duration-unit-cs2/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="DurationUnitCS2.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/duration-unit-cs2/durationUnitCS2.cs %}
{% endhighlight %}
{% endtabs %}

...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/excel-export/excelExport/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ExcelExport.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/excel-export/excelExport/excelExport.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/excel-export/excelExport/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ExcelExport.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/excel-export/excelExport/excelExport.cs %}
{% endhighlight %}

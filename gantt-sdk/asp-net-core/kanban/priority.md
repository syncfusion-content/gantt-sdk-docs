---
layout: post
title: Priority Management in ASP.NET Core Kanban | Syncfusion
description: Learn how to manage task priorities in Syncfusion ASP.NET Core Kanban and organize work by priority levels.
keywords: asp-net-core kanban priority, syncfusion kanban, task priority, workflow
canonical: https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/priority
platform: gantt-sdk
...
# Priority Management in ASP.NET Core Kanban
...
{% include code-snippet/gantt-sdk/asp-net-core/kanban/priority/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Datasource.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/kanban/priority/datasource.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/kanban/priority/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Datasource.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/kanban/priority/datasource.cs %}
{% endhighlight %}

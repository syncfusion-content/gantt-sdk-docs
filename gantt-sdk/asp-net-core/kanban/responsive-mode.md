...
![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/default-layout.PNG)
...
![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/swimlane-layout.PNG)

## Scrolling

Column scrolling will be shown when exceeding the screen size in the columns.

![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/mobile-scrolling.PNG)
...
![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/single-selection.PNG)

### Multiple Selection

Enable [`selectionType`](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Kanban.KanbanCardSettings.html#Syncfusion_EJ2_Kanban_KanbanCardSettings_SelectionType) as `Multiple` to select multiple cards. It will open the popup on the screen top. Selected card header text will be shown when selecting single card with a tap and hold action. If single card is selected, only tap action is required to select multiple cards. Multiple Selected card count will be shown on the popup when selecting multiple cards.

![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/single-multiple.PNG)

![kanban](https://help.syncfusion.com/gantt-sdk/asp-net-core/kanban/images/multiple-multiple.PNG)

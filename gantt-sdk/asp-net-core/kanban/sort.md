---
layout: post
title: Sort in ASP.NET Core Kanban Component
description: Learn here all about Sort in Syncfusion ASP.NET Core Kanban component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Sort

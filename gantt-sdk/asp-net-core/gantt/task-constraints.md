...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs1/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Constraints.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs1/constraints.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs1/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Constraints.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs1/constraints.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs2/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ConstraintsPopup.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs2/constraintsPopup.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs2/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ConstraintsPopup.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/task-scheduling/task-constraints-cs2/constraintsPopup.cs %}
{% endhighlight %}

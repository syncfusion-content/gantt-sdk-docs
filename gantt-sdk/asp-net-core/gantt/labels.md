---
layout: post
title: Labels in ASP.NET Core Gantt Component
description: Learn here all about Labels in Syncfusion ASP.NET Core Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Labels

...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/assignResource/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="AssignResource.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/assignResource/assignResource.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/assignResource/razor %}
{% endhighlight %}
{% highlight c# tabtitle="AssignResource.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/assignResource/assignResource.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/resourceUnit/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ResourceUnit.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/resourceUnit/resourceUnit.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/resourceUnit/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ResourceUnit.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resources/resourceUnit/resourceUnit.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resource-customization/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ResCustomize.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resource-customization/rescustomize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resource-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ResCustomize.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/resource-customization/rescustomize.cs %}
{% endhighlight %}

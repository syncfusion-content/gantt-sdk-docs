---
layout: post
title: Event Markers in ASP.NET Core Gantt Component
description: Learn here all about Event Markers in Syncfusion ASP.NET Core Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/eventmarkers/eventmarkers/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Eventmarkers.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/eventmarkers/eventmarkers/eventmarkers.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt/eventmarkers/eventmarkers/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Eventmarkers.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt/eventmarkers/eventmarkers/eventmarkers.cs %}
{% endhighlight %}

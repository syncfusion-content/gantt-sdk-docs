...
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/defaultdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Defaultdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/defaultdrag/defaultdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/defaultdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Defaultdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/defaultdrag/defaultdrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/multidrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Multidrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/multidrag/multidrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/multidrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multidrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/multidrag/multidrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/taskbardragdrop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="TaskbarDragDrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/taskbardragdrop/taskbardragdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/taskbardragdrop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="TaskbarDragDrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/taskbardragdrop/taskbardragdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrag/preventdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrag/preventdrag.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrop/preventdrop.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Preventdrop.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventdrop/preventdrop.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventReorder/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="PreventReorder.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventReorder/preventReorder.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventReorder/razor %}
{% endhighlight %}
{% highlight c# tabtitle="PreventReorder.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/preventReorder/preventReorder.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/dynamicdrag/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamicdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/dynamicdrag/dynamicdrag.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/dynamicdrag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamicdrag.cs" %}
{% include code-snippet/gantt-sdk/asp-net-core/gantt-chart/rows/dynamicdrag/dynamicdrag.cs %}
{% endhighlight %}

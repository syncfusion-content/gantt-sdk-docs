---
layout: post
title: New Row Position in TypeScript Gantt Chart | Syncfusion
description: Learn how to configure new row position in Syncfusion TypeScript Gantt Chart to control where new tasks are inserted in the project hierarchy.
keywords: TypeScript gantt new row position, add row position, insert position, task position, row insertion, syncfusion gantt
canonical: https://help.syncfusion.com/gantt-sdk/TypeScript/gantt-chart/how-to/new-row-position
platform: gantt-sdk
...
# Controlling New Row Position When Adding Tasks in TypeScript Gantt Chart Control

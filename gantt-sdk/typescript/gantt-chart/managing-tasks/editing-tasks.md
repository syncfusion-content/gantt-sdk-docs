...
> **Note:** You can also define custom fields in the add/edit dialog General tab using the [fields](https://ej2.syncfusion.com/documentation/api/gantt/addDialogFieldSettings#fields) property.

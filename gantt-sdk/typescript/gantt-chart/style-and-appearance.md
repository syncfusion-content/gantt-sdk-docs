...
description: Learn how to customize style and appearance of Syncfusion TypeScript Gantt Chart with CSS overrides, grid lines, and theme customization options.
keywords: typescript gantt styling, css customization, theme, grid lines, syncfusion gantt
...
## Customizing TypeScript Gantt Chart root element

The `.e-gantt` class is the root container for the entire TypeScript Gantt Chart. Customize this element to control global appearance including font family, background color, and overall spacing:
...
This customization applies a cursive font to the TypeScript Gantt Chart content. Additional styling can be applied to rows, alternate rows, selected rows, and hover states. Avoid using `!important` for hover styles in production environments. Instead, increase selector specificity to maintain consistent styling control.

## Styling the grid section

### Customizing grid headers in TypeScript Gantt Chart

The grid header in the TypeScript Gantt Chart contains column headers and table structures. Customize the header appearance and styling using the following CSS classes:
...
The baseline in the TypeScript Gantt Chart represents planned task schedules for comparison with actual progress. Customize baseline bars and milestones using these CSS classes:
...
The connector lines in the TypeScript Gantt Chart show dependencies between tasks. Apply CSS to modify the connector line appearance and styling:
...
The labels in the TypeScript Gantt Chart display task information on the taskbars. Apply CSS to modify the label appearance and styling:
...
The event markers in the TypeScript Gantt Chart highlight important dates or milestones on the timeline. Apply CSS to modify the event marker appearance and styling:
...
The tooltip in the TypeScript Gantt Chart displays detailed information when hovering over tasks or elements. Apply CSS to modify the tooltip appearance and styling. Note: Use `.e-tooltip-wrap` for most tooltip styling and `.e-gantt-tooltip` for additional customization:
...
Below is a complete example demonstrating how to customize multiple aspects of the TypeScript Gantt Chart using CSS classes:

{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/style-appearance-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/style-appearance-cs1/index.html %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/typescript/gantt-chart/style-appearance-cs1" %}

![style and appearance](../images/style-and-appearance.png)

## Configuring grid lines in the TypeScript Gantt Chart

Grid lines on the tree grid and chart sections can be shown or hidden using the [gridLines](https://ej2.syncfusion.com/documentation/api/gantt#gridlines) property. This property controls the visibility of grid lines throughout the component. The available grid line options are:

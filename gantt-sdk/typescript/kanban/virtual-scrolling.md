---
layout: post
title: Virtual Scrolling in TypeScript Kanban | Syncfusion
description: Learn how to implement virtual scrolling in Syncfusion TypeScript Kanban for efficient rendering of large datasets.
keywords: typescript kanban virtual scrolling, syncfusion kanban, scrolling, performance
canonical: https://help.syncfusion.com/gantt-sdk/typescript/kanban/virtual-scrolling
platform: gantt-sdk
...
# Virtual Scrolling and Performance in TypeScript Kanban

Kanban allows you to load a large amount of data without any performance degradation. This feature can be enabled by setting the [`enableVirtualization`](https://ej2.syncfusion.com/documentation/api/kanban#enableVirtualization) property in the Kanban to `true`.

## Virtual scrolling

Virtual scrolling optimizes data rendering within each column when using large datasets. Only a subset of cards that are visible and about to be loaded on the screen are rendered. The number of records displayed in the Kanban is determined implicitly by the height of the Kanban area and the card height. The [`cardHeight`](https://ej2.syncfusion.com/documentation/api/kanban#cardHeight) property of Kanban can be used to set the cards' height in pixel value. By default, the card height will be `auto`.
...
{% include code-snippet/gantt-sdk/typescript/kanban/virtual-scrolling-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/typescript/kanban/virtual-scrolling-cs1/index.html %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/typescript/kanban/virtual-scrolling-cs1" %}


### Configure the remote data service

When the remote data is configured for the [`dataSource`](https://ej2.syncfusion.com/documentation/api/kanban#dataSource), the service method will receive an additional `KanbanVirtualization` parameter to handle the initial data load for Kanban Virtualization.

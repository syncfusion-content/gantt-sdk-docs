---
layout: post
title: Splitting and Merging Tasks in JavaScript Gantt Chart | Syncfusion
...
For more details, see [Split task at load time](https://ej2.syncfusion.com/javascript/documentation/gantt/data-binding#split-task).

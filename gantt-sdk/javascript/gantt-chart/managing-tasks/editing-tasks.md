...
> **Note:** When the edit mode is set to `Auto`, on performing double-click action on TreeGrid side, the cells will be changed to editable mode. On performing double-click action on chart side, the edit dialog will appear for editing the task details.
...
> **Note:** You can also define custom fields in the add/edit dialog General tab using the [fields](https://ej2.syncfusion.com/javascript/documentation/api/gantt/addDialogFieldSettings#fields) property.

...
{% include code-snippet/gantt-sdk/javascript/gantt/pdf-export-customization-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/javascript/gantt/pdf-export-customization-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/javascript/gantt/pdf-export-customization-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/javascript/gantt/pdf-export-customization-cs1/index.html %}
{% endhighlight %}

...
# Managing Task Dependencies in JavaScript Gantt Chart
...
> - The format of the dependency string depends on the data type of the [id](https://ej2.syncfusion.com/javascript/documentation/api/gantt/taskfields#id) field mapped in the data source:

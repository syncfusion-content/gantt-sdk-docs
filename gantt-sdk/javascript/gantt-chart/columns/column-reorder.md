...
# Column Reordering with Drag and Drop Support in JavaScript Gantt Chart
...
You can customize the column reorder behavior in Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Gantt using the [columnDragStart](https://ej2.syncfusion.com/javascript/documentation/gantt/events#columndragstart), [columnDrag](https://ej2.syncfusion.com/javascript/documentation/gantt/events#columndrag), and [columnDrop](https://ej2.syncfusion.com/javascript/documentation/gantt/events#columndrop) events. These events provide control over each stage of the column drag-and-drop process, allowing for custom logic or restrictions.

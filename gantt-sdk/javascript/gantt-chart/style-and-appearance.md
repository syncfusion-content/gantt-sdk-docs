---
layout: post
title: Styling in JavaScript Gantt Chart | Syncfusion
description: Learn how to customize style and appearance of Syncfusion JavaScript Gantt Chart using CSS overrides, themes, grid lines, colors, and visual configurations.
keywords: javascript gantt styling, css customization, themes, appearance, colors, visual customization, syncfusion gantt
...
{% include code-snippet/gantt-sdk/javascript/gantt-chart/gridline-cs1/index.ts %}
{% endhighlight %}

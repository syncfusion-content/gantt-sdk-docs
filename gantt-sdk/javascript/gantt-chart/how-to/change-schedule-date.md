---
layout: post
title: Update Project Schedule Dates in JavaScript Gantt Chart | Syncfusion
...
{% include code-snippet/gantt-sdk/javascript/gantt-chart/how-to-changescheduledates-cs1/index.ts %}
{% endhighlight %}

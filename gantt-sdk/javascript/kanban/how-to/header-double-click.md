---
layout: post
title: Header Double-Click in JavaScript Kanban | Syncfusion
description: Learn how to handle column header double-click events in Syncfusion JavaScript Kanban with practical examples and configuration guidance.
keywords: javascript kanban header double click, syncfusion kanban, header event, column header
canonical: https://help.syncfusion.com/gantt-sdk/javascript/kanban/how-to/header-double-click
platform: gantt-sdk
...
{% include code-snippet/gantt-sdk/javascript/kanban/how-to-cs1/index.js %}
{% endhighlight %}

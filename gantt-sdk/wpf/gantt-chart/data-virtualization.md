...
description: Learn about Data Virtualization support in Syncfusion Essential Studio® WPF Gantt by using row and timeline virtualization to efficiently handle large datasets.re.
platform: gantt-sdk
control: Gantt
documentation: ug
---

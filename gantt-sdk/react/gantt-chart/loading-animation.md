...
let parent = {};
/_ tslint:disable:no-string-literal _/
parent['TaskID'] = x;
...
{% include code-snippet/gantt-sdk/react/gantt/loadinganimation-cs1/index.html %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/react/gantt/loadinganimation-cs1" %}

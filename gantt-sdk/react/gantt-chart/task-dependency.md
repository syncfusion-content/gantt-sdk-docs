...
> - The format of the dependency string depends on the data type of the [id](https://ej2.syncfusion.com/react/documentation/api/gantt/taskfields#id) field mapped in the data source:

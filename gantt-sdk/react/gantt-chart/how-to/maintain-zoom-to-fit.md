---
layout: post
title: Maintain Zoom to Fit in React Gantt Chart | Syncfusion
description: Learn how to maintain zoom-to-fit in Syncfusion React Gantt Chart during task editing and dynamic data source changes to preserve the timeline view.
keywords: react gantt zoom to fit, maintain zoom, zoom persistence, dynamic data zoom, syncfusion gantt
canonical: https://help.syncfusion.com/gantt-sdk/react/gantt-chart/how-to/maintain-zoom-to-fit
platform: gantt-sdk
...
# Preserving Zoom-to-Fit During Editing and Data Changes in React Gantt Chart

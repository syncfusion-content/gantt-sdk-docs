---
layout: post
title: Custom Fields in React Gantt Chart | Syncfusion
description: Learn how to configure custom fields in Syncfusion React Gantt Chart's add and edit dialogs for enhanced task data management and input capture.
keywords: react gantt custom fields, add dialog fields, edit dialog fields, custom task data, syncfusion gantt
canonical: https://help.syncfusion.com/gantt-sdk/react/gantt-chart/how-to/custom-field
platform: gantt-sdk
...
# Adding Custom Fields to the Task Dialog in React Gantt Chart
...
{% include code-snippet/gantt-sdk/react/gantt-chart/how-to-customfield-cs1/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/gantt-sdk/react/gantt-chart/how-to-customfield-cs1/app/index.tsx %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/react/gantt-chart/how-to-customfield-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/react/gantt-chart/how-to-customfield-cs1" %}

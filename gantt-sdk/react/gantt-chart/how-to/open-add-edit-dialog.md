---
layout: post
title: Open Add and Edit Dialog in React Gantt Chart | Syncfusion
description: Learn how to open the add and edit dialogs programmatically in Syncfusion React Gantt Chart for efficient task creation and modification.
keywords: react gantt add dialog, edit dialog, open dialog programmatically, task dialog, syncfusion gantt
canonical: https://help.syncfusion.com/gantt-sdk/react/gantt-chart/how-to/open-add-edit-dialog
platform: gantt-sdk
control: Add and Edit Dialog - Gantt Chart
documentation: ug
domainurl: https://help.syncfusion.com/gantt-sdk
---

# Programmatically Opening Add and Edit Dialogs in React Gantt Chart

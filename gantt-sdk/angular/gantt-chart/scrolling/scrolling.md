...
description: Learn how to optimize scrolling in Syncfusion Angular Gantt Chart with custom templates and event handling
platform: gantt-sdk
...
The Angular Gantt Chart component provides built-in support for automatically scrolling to specific tasks and timeline positions, which is especially useful when working with large datasets.

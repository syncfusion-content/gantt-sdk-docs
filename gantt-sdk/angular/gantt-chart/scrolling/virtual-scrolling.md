...
description: Learn how to configure virtual scrolling in Syncfusion Angular Gantt Chart to render only visible tasks and timeline cells, optimizing performance for large datasets.

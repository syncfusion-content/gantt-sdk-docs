...
keywords: angular gantt column headers, header text, header template, custom header, syncfusion gantt
...
In the context of the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Gantt chart component, you can use ngx-translate to translate the header text of its columns. There are two ways to achieve this: through header text and through header template.
...
To translate the header text of the Gantt chart's columns using **ngx-translate** through header template, you can use the **translate** pipe in the header templates of its component.
...
>* The UID is automatically generated by the Gantt chart component and may change whenever it is refreshed or updated.

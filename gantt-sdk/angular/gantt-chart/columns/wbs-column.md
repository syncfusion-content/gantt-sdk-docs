...
description: Learn how to add wbs column in Syncfusion Angular Gantt Chart with custom templates and event handling
platform: gantt-sdk
...
# WBS Column with Hierarchical Task Identification in Angular Gantt Chart

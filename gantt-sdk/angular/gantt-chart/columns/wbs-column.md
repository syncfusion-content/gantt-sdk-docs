...
keywords: Angular Gantt Chart wbs column, work breakdown structure, wbs code, task hierarchy, syncfusion gantt
...
To enable WBS in the Angular Gantt Chart component:
...
* **No Direct Field Mapping**: WBS Code and WBS Predecessor fields cannot be mapped directly from the data source. These values are automatically generated by the Angular Gantt Chart based on the parent-child task relationships defined in the data.

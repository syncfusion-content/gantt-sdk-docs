...
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs1/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs1/src/main.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs1" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs2/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs2/src/main.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columntype-cs1/src/data.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs2" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs3/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs3/src/main.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columntype-cs1/src/data.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs3" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs6/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs6/src/main.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columntype-cs1/src/data.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs6" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs4/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs4/src/main.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columntype-cs1/src/data.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs4" %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs5/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columnresize-cs5/src/main.ts %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt/columns/columntype-cs1/src/data.ts %}
{% endhighlight %}
...
{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt/columns/columnresize-cs5" %}

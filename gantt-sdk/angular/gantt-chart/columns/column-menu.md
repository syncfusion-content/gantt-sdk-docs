...
description: Learn how to use column menu in Syncfusion Angular Gantt Chart with custom templates and event handling
platform: gantt-sdk
...
# Column Menu with Sort, Filter, and Autofit Options in Angular Gantt Chart

...
{% include code-snippet/gantt-sdk/angular/kanban/getting-started-key-field-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/custom-dialog-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/label-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/fields-validation-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/dialog-template-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/prevent-dialog-cs1/src/app.component.ts %}
{% endhighlight %}

...
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-key-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-text-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-template-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-sort-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-drag-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-empty-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-total-cs1/src/app.component.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/gantt-sdk/angular/kanban/swimlane-enable-frozen-cs1/src/app.component.ts %}
{% endhighlight %}

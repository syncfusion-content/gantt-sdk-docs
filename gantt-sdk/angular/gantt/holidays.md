---
layout: post
title: Holidays in Angular Gantt Chart Component | Syncfusion
description: Learn how to configure holidays in the Syncfusion Angular Gantt Chart component for accurate task scheduling with non-working days.
platform: gantt-sdk
control: Holidays
documentation: ug
...
{% include code-snippet/gantt-sdk/angular/gantt-chart/holidays/default-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt-chart/holidays/default-cs1/src/main.ts %}
{% endhighlight %}

{% highlight ts tabtitle="datasource.ts" %}
{% include code-snippet/gantt-sdk/angular/gantt-chart/holidays/default-cs1/src/data.ts %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/samples/gantt-sdk/angular/gantt-chart/holidays/default-cs1" %}

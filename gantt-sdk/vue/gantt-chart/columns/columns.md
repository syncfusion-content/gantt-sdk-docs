...
To format cell values based on a specific culture, use the [columns.format](https://ej2.syncfusion.com/vue/documentation/api/gantt/column#format) property. The Gantt Chart component uses the Internationalization library to format `number` and `date` values.

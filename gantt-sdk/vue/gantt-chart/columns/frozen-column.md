...
To enable frozen columns, use the [frozenColumns](https://ej2.syncfusion.com/vue/documentation/api/gantt#frozencolumns) property in the Gantt Chart component.
...
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs1" %}
...
To freeze a particular column in the Gantt, set the [isFrozen](https://ej2.syncfusion.com/vue/documentation/api/gantt/column#isfrozen) property of the column to **true**.

The following example demonstrates how to freeze a particular column in the Gantt using the `isFrozen` property.

{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs2/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs2/app.vue %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs2" %}
...
To achieve this, the [column.freeze](https://ej2.syncfusion.com/vue/documentation/api/gantt/column#freeze) property can be utilized. This property is used to specify the freeze direction for individual columns.
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs3/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs3/app.vue %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs3" %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs4/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs4/app.vue %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/gantt-sdk/vue/gantt-chart/frozen-column-cs4" %}

## Limitations

* Freeze Direction is not compatible with the [isFrozen](https://ej2.syncfusion.com/vue/documentation/api/gantt/column#isfrozen) and [frozenColumns](https://ej2.syncfusion.com/vue/documentation/api/gantt#frozencolumns) properties.
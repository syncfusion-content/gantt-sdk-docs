...
To bind remote data to the Gantt Chart component, assign service data as an instance of `DataManager` to the [dataSource](https://ej2.syncfusion.com/vue/documentation/api/gantt#datasource) property.

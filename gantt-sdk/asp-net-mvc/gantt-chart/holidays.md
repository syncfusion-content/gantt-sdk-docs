---
layout: post
title: Holidays in ASP.NET MVC Gantt Component
description: Learn here all about Holidays in Syncfusion ASP.NET MVC Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Holidays
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/holidays/holidays/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Holidays.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/holidays/holidays/holidays.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/holidays/holidays/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Holidays.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/holidays/holidays/holidays.cs %}
{% endhighlight %}

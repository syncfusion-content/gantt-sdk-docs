...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addingRow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="AddingRow.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addingRow/addingRow.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addingRow/razor %}
{% endhighlight %}
{% highlight c# tabtitle="AddingRow.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addingRow/addingRow.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/contextMenu/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ContextMenu.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/contextMenu/contextMenu.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/contextMenu/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ContextMenu.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/contextMenu/contextMenu.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addRow/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="AddRow.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addRow/addRow.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addRow/razor %}
{% endhighlight %}
{% highlight c# tabtitle="AddRow.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/rows/addRow/addRow.cs %}
{% endhighlight %}

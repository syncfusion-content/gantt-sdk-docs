...
To perform `long press` action on a row, [`context menu`](https://help.syncfusion.com/gantt-sdk/asp-net-mvc/gantt-chart/context-menu) is opened, and then tap a menu item to trigger its action.

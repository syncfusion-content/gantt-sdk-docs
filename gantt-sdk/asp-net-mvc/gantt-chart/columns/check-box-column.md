...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/columns/checkbox/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Checkbox.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/columns/checkbox/checkbox.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/columns/checkbox/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Checkbox.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/columns/checkbox/checkbox.cs %}
{% endhighlight %}

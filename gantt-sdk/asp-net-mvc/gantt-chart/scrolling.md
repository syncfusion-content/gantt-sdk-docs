...
To specify the [`width`](https://ej2.syncfusion.com/documentation/api/gantt#width) and [`height`](https://ej2.syncfusion.com/documentation/api/gantt#height) of the scroller in pixels, set the pixel value to a number.

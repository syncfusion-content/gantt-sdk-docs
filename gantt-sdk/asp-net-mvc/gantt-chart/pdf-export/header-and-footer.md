---
layout: post
title: Header and footer of PDF export in Syncfusion ASP.NET MVC Gantt Component
description: Learn here all about Header and footer of PDF export in Syncfusion ASP.NET MVC Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Pdf Export
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/pdf-customization/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="PDF-customization.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/pdf-customization/pdf-customization.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/pdf-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="PDF-customization.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/pdf-customization/pdf-customization.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/footer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Footer.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/footer/footer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/footer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Footer.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/pdf-export/footer/footer.cs %}
{% endhighlight %}

...
keywords: asp.net mvc gantt baseline, planned schedule, actual timeline, project comparison, schedule deviations, syncfusion gantt chart
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baseline/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Baseline.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baseline/baseline.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baseline/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Baseline.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baseline/baseline.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baselineTemplate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Contextmenu.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baselineTemplate/baselineTemplate.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baselineTemplate/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Contextmenu.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt-chart/baseline/baselineTemplate/baselineTemplate.cs %}
{% endhighlight %}

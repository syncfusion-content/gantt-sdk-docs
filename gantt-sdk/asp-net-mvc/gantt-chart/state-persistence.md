---
layout: post
title: State Persistence in ASP.NET MVC Gantt Chart | Syncfusion
description: Learn how to enable state persistence in Syncfusion ASP.NET MVC Gantt Chart to save and restore user preferences, columns, and view settings.
keywords: asp.net mvc gantt state persistence, user preferences, local storage, save state, restore state, syncfusion gantt chart
canonical: https://help.syncfusion.com/gantt-sdk/asp-net-mvc/gantt-chart/state-persistence
platform: gantt-sdk
...
# State Persistence with LocalStorage Support in ASP.NET MVC Gantt Chart
...
State persistence stores gantt’s model object in the local storage when the [`enablePersistence`](https://help.syncfusion.com/cr/aspnetmvc-js2/Syncfusion.EJ2.Gantt.Gantt.html#Syncfusion_EJ2_Gantt_Gantt_EnablePersistence) is defined as true.

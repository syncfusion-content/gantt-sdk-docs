...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/customizations/tasklabelTemplate/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="TasklabelTemplate.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/customizations/tasklabelTemplate/tasklabelTemplate.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/customizations/tasklabelTemplate/razor %}
{% endhighlight %}
{% highlight c# tabtitle="TasklabelTemplate.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/customizations/tasklabelTemplate/tasklabelTemplate.cs %}
{% endhighlight %}

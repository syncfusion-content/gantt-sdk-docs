...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/same-time/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Same-time.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/same-time/same-time.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/same-time/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Same-time.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/same-time/same-time.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/timezone-CRUD/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Timezone-CRUD.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/timezone-CRUD/timezone-CRUD.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/timezone-CRUD/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Timezone-CRUD.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/timezone/timezone-CRUD/timezone-CRUD.cs %}
{% endhighlight %}

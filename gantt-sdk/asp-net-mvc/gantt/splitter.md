...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/changeSplitter/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ChangeSplitter.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/changeSplitter/changeSplitter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/changeSplitter/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ChangeSplitter.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/changeSplitter/changeSplitter.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/setSplitterPosition/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="SetSplitterPosition.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/setSplitterPosition/setSplitterPosition.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/setSplitterPosition/razor %}
{% endhighlight %}
{% highlight c# tabtitle="SetSplitterPosition.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/how-to/setSplitterPosition/setSplitterPosition.cs %}
{% endhighlight %}

---
layout: post
title: Immutable in Syncfusion ASP.NET MVC Gantt Component
description: Learn here all about Immutable in Syncfusion ASP.NET MVC Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Immutable
...
# Immutable in Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Gantt component
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/immutable/immutable/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="immutable.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/immutable/immutable/immutable.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/immutable/immutable/razor %}
{% endhighlight %}
{% highlight c# tabtitle="immutable.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/immutable/immutable/immutable.cs %}
{% endhighlight %}

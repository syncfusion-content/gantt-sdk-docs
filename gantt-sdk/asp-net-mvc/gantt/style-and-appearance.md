---
layout: post
title: Style And Appearance in ASP.NET MVC Gantt Component
description: Learn here all about Style And Appearance in Syncfusion ASP.NET MVC Gantt component of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/appearance-and-styling/gridLines/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="GridLines.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/appearance-and-styling/gridLines/gridLines.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/appearance-and-styling/gridLines/razor %}
{% endhighlight %}
{% highlight c# tabtitle="GridLines.cs" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/gantt/appearance-and-styling/gridLines/gridLines.cs %}
{% endhighlight %}

...
2. After completing the required form or logging in with your registered Syncfusion account, you can download the trial installer from the confirmation page (as shown in the screenshot below).
   ...
   ![Trial and downloads of Syncfusion Gantt SDK](images/trial-confirmation.png)
   
3. With a trial license, only the latest version’s trial installer can be downloaded.
4. Unlock key is not required to install the Syncfusion Gantt SDK Linux trial installer.
5. Before the trial expires, you can download the trial installer at any time from your registered account's [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page (as shown in the screenshot below).
   ...
   ![Trial and downloads of Syncfusion Gantt SDK](images/trial-download.png)

6. Click the More Downloads Options (element 2 in the above screenshot) button to get the Gantt SDK Product Offline trial installer which is available in ZIP format.

   ![Trial and downloads of Syncfusion Gantt SDK](images/start-trial-download-offline-installer.png)
...
1. You can start your 30-day free trial from the [Start Trial](https://www.syncfusion.com/account/manage-trials/start-trials) page from your account.
   ...
   N> You can generate the license key for your active trial products from [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page. This license key will be mandatory to use our trial products in your application. To know more about License key, refer to this [help topic](https://help.syncfusion.com/common/essential-studio/licensing/overview).
    ...
    ![Trial and downloads of Syncfusion Gantt SDK](images/start-trial-download.png)
...
4. After you've started the trial, go to the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page to get the latest version trial installer. You can generate the [unlock key](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) and [license key](https://help.syncfusion.com/common/essential-studio/licensing/how-to-generate) here at any time before the trial period expires (as shown in the screenshot below).
   ...
   ![License and downloads of Syncfusion Gantt SDK](images/start-trial-download-installer.png)
...
3. You can download the Gantt SDK Linux licensed installer by going to More Downloads Options (element 3 in the screenshot below).

   ![License and downloads of Syncfusion Gantt SDK](images/license-download.png)
   
4. Unlock key is not required to install the Syncfusion Gantt SDK Linux licensed installer.    	
5. For Linux OS, the ZIP format is available for download.
   
   ![License and downloads of Syncfusion Gantt SDK](images/Linux_Download.PNG)

You can also refer to the [**Gantt SDK Linux installer**](https://help.syncfusion.com/gantt-sdk/installation/linux-installer/how-to-install) link for step-by-step installation guidelines.	

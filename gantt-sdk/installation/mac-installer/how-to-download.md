...
4. Unlock key is not required to install the Syncfusion Gantt SDK Mac trial installer.
...
6. Click the More Downloads Options (element 2 in the above screenshot) button to get the Essential Studio Gantt SDK Mac trial installer which is available in PKG format.
...
1. You can start your 30-day free trial from the [Start Trial](https://www.syncfusion.com/account/manage-trials/start-trials) page from your account.
   ...
   N> You can generate the license key for your active trial products from the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page. This license key is mandatory to use our trial products in your application. To learn more about the License key, refer to this [help topic](https://help.syncfusion.com/common/essential-studio/licensing/overview).
...
3. You can download the Gantt SDK Mac licensed installer by going to More Downloads Options (element 3 in the screenshot below).

   ![License and downloads of Syncfusion Essential Studio](images/license-download.png)

4. An unlock key is not required to install the Syncfusion Gantt SDK Mac licensed installer.
5. For macOS, the PKG format is available for download.

   ![License and downloads of Syncfusion Essential Studio](images/Mac_Download.PNG)

You can also refer to the [**Gantt SDK Mac installer**](https://help.syncfusion.com/gantt-sdk/installation/mac-installer/how-to-install) link for step-by-step installation guidelines.	

...
description: Check out and learn about the documentation for getting started with Blazor Kanban Component in Blazor Server App.
platform: gantt-sdk
component: Kanban
documentation: ug
---
...
After the packages are installed, open the **~/Components/_Imports.razor** file and import the `Syncfusion.Blazor` and `Syncfusion.Blazor.Kanban` namespaces.
...
Open a Razor file located in the **~/Components/Pages/*.razor** (for example, **Home.razor**) and add the [Blazor Kanban](https://www.syncfusion.com/gantt-sdk/blazor-kanban-board) component inside the razor file.

...
To add Blazor Gantt Chart component in the app, open the NuGet package manager in Visual Studio (_Tools → NuGet Package Manager → Manage NuGet Packages for Solution_), search and install [Syncfusion.Blazor.Gantt](https://www.nuget.org/packages/Syncfusion.Blazor.Gantt) and [Syncfusion.Blazor.Themes](https://www.nuget.org/packages/Syncfusion.Blazor.Themes/). Alternatively, you can utilize the following package manager command to achieve the same.
...
For further details regarding Columns, refer [here](https://blazor.syncfusion.com/documentation/gantt/columns).
...
You can find the full information regarding Editing from [here](https://blazor.syncfusion.com/documentation/gantt/managing-tasks)
...
You can find the full information regarding Filtering from [here](https://blazor.syncfusion.com/documentation/gantt/filtering)
...
You can find the full information regarding Sorting from [here](https://blazor.syncfusion.com/documentation/gantt/sorting)
...
You can find the full information regarding Predecessors from [here](https://blazor.syncfusion.com/documentation/gantt/task-dependencies)

...
description: Learn how to configure and customize rows in the Syncfusion Blazor Gantt Chart component for optimal data display and user interaction.
platform: gantt-sdk
control: Gantt Chart
documentation: ug
---

# Rows in Blazor Gantt Chart

...
description: Learn about getting started with the Syncfusion Blazor Gantt Chart component in a Blazor WebAssembly application.
platform: gantt-sdk
control: Gantt Chart
documentation: ug
---

# Getting Started with Blazor Gantt Chart

...
description: Learn how to manage component state in the Syncfusion Blazor Gantt Chart component to persist user interactions and selections."
platform: gantt-sdk
control: Gantt Chart
documentation: ug
---

# State Management in Blazor Gantt Chart

---
layout: post
title: Sorting in WinUI Kanban Board | Syncfusion<sup>®</sup>
description:  Learn about Sorting support in Syncfusion<sup>®</sup> WinUI Kanban Board, including custom fields, sort orders, and comparer-based card sorting.
platform: gantt-sdk
control: SfKanban
documentation: ug
---
...
The index-based approach in the WinUI Kanban Board control allows cards to be dropped at precise positions within a column. Upon dropping, the card's index is updated based on the index of the previous card. Additionally, the index of the next card is incremented relative to the drop position to maintain continuous ordering.
